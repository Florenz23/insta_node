...
// class Instagram
{
  ...
  */
  ...
  {
    //request photo contents
    fetch(photoUrl).then(file => file.text().then(fileContents =>
    {

      fs.writeFile('file.jpeg', fileContents,() =>
      {
        let headers = this.getHeaders()
        let form = new formData();

        // form.append('upload_id', '1494799294290')

        console.log(fs.createReadStream('file.jpeg'))

        form.append('photo', fs.createReadStream('file.jpeg'), {
        header: '------WebKitFormBoundaryO71MTGAmXAW7BFk0',
        filename: 'file.jpg',
        name: 'photo',
      ...
      // console.log(form)
        ...
        headers['content-length'] = '176';
        headers['content-type'] = 'multipart/form-data; boundary=----WebKitFormBoundaryO71MTGAmXAW7BFk0';

        // console.log(form.length)

        fetch('https://www.instagram.com/create/upload/photo/',
        {
          headers: headers,
          method: 'post',
          body: form
        }).then(answer => answer.text().then(t => console.log(t)))
      })
